...
func (m *MockPost) Create(ctx context.Context, accountID entity.AccountID, title, body string, tags []string, imageIDs []int) (entity.Post, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, accountID, title, body, tags, imageIDs)
...
func (mr *MockPostMockRecorder) Create(ctx, accountID, title, body, tags, imageIDs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockPost)(nil).Create), ctx, accountID, title, body, tags, imageIDs)
}
