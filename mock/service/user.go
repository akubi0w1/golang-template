...
func (m *MockUser) Authorize(ctx context.Context, accountID entity.AccountID, password string) (entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUser) Create(ctx context.Context, accountID entity.AccountID, email entity.Email, password, name, avatarURL string) (entity.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, accountID, email, password, name, avatarURL)
	ret0, _ := ret[0].(entity.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserMockRecorder) Create(ctx, accountID, email, password, name, avatarURL interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockUser)(nil).Create), ctx, accountID, email, password, name, avatarURL)
}
...
func (m *MockUser) GetByAccountID(ctx context.Context, accountID entity.AccountID) (entity.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserMockRecorder) GetByAccountID(ctx, accountID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByAccountID", reflect.TypeOf((*MockUser)(nil).GetByAccountID), ctx, accountID)
}
