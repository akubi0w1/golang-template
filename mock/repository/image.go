...
func (m *MockImage) FindByIDs(ctx context.Context, ids []int) (entity.ImageList, error) {
	m.ctrl.T.Helper()
...
func (mr *MockImageMockRecorder) FindByIDs(ctx, ids interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByIDs", reflect.TypeOf((*MockImage)(nil).FindByIDs), ctx, ids)
}
